...
case class CurrentAccountWithStatus (
  ...
  /* `status: Registered` iso-link: [click-here](https://www.iso20022.org/standardsrepository/public/wqt/Description/mx/dico/bc/_E4gZEcTGEeChad0JzLk7QA_2010102987/elements/_E4gZE8TGEeChad0JzLk7QA_1025780411)  */
