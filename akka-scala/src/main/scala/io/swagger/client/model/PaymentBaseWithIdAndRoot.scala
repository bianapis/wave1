...
case class PaymentBaseWithIdAndRoot (
  /* `status: Provisionally Registered` bian-reference:  CashAccount.Payment.PaymentOrder core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::ISO20022andUNCEFACT::Identifier  */
  paymentInstructionReference: Option[String],
  /* `status: Registered` bian-reference:  CashAccount.Payment.PartyRole(asCreditorRole)(asPaymentPartyRole).CashAccount.Identification iso-link: [click-here](https://www.iso20022.org/standardsrepository/public/wqt/Description/mx/dico/bc/_E1rHgsTGEeChad0JzLk7QA_-1068889728/elements/_E1rHhcTGEeChad0JzLk7QA_-755813725)  */
